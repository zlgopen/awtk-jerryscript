...
ret_t canvas_t_init(JSContext* ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"canvas_reset_cache",
                                 wrap_canvas_reset_cache);
...
ret_t event_type_t_init(JSContext* ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"EVT_LOCALE_INFOS_LOAD_INFO",
                                 get_EVT_LOCALE_INFOS_LOAD_INFO);
  jerryx_handler_register_global((const jerry_char_t*)"EVT_LOCALE_INFOS_UNLOAD_INFO",
...
ret_t key_code_t_init(JSContext* ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"TK_KEY_NUMLOCKCLEAR",
                                 get_TK_KEY_NUMLOCKCLEAR);
...
ret_t locale_infos_t_init(JSContext* ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"locale_infos_unref",
                                 wrap_locale_infos_unref);
  jerryx_handler_register_global((const jerry_char_t*)"locale_infos_change",
                                 wrap_locale_infos_change);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"locale_infos_reload_all",
                                 wrap_locale_infos_reload_all);
...
ret_t style_id_t_init(JSContext* ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"STYLE_ID_GRID_COLOR",
                                 get_STYLE_ID_GRID_COLOR);
  jerryx_handler_register_global((const jerry_char_t*)"STYLE_ID_EVEN_BG_COLOR",
                                 get_STYLE_ID_EVEN_BG_COLOR);
  jerryx_handler_register_global((const jerry_char_t*)"STYLE_ID_ODD_BG_COLOR",
                                 get_STYLE_ID_ODD_BG_COLOR);
...
ret_t system_info_flag_t_init(JSContext* ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"SYSTEM_INFO_FLAG_NONE",
                                 get_SYSTEM_INFO_FLAG_NONE);
  jerryx_handler_register_global((const jerry_char_t*)"SYSTEM_INFO_FLAG_FAST_LCD_PORTRAIT",
                                 get_SYSTEM_INFO_FLAG_FAST_LCD_PORTRAIT);
...
ret_t bitmap_flag_t_init(JSContext* ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"BITMAP_FLAG_LCD_ORIENTATION",
                                 get_BITMAP_FLAG_LCD_ORIENTATION);
  jerryx_handler_register_global((const jerry_char_t*)"BITMAP_FLAG_GPU_FBO_TEXTURE",
                                 get_BITMAP_FLAG_GPU_FBO_TEXTURE);
...
ret_t widget_prop_t_init(JSContext* ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_LINE_HEIGHT",
                                 get_WIDGET_PROP_LINE_HEIGHT);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_LOADING",
                                 get_WIDGET_PROP_LOADING);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_EASY_TOUCH_MODE",
                                 get_WIDGET_PROP_EASY_TOUCH_MODE);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_ELLIPSES",
                                 get_WIDGET_PROP_ELLIPSES);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_APPLET_NAME",
                                 get_WIDGET_PROP_APPLET_NAME);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_RUNNING",
                                 get_WIDGET_PROP_RUNNING);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_ENABLE_PREVIEW",
                                 get_WIDGET_PROP_ENABLE_PREVIEW);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_THEME_OF_POPUP",
                                 get_WIDGET_PROP_THEME_OF_POPUP);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_SHOW_GRID",
                                 get_WIDGET_PROP_SHOW_GRID);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_COLUMNS_DEFINITION",
                                 get_WIDGET_PROP_COLUMNS_DEFINITION);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_DRAG_THRESHOLD",
                                 get_WIDGET_PROP_DRAG_THRESHOLD);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_ANIMATING_TIME",
                                 get_WIDGET_PROP_ANIMATING_TIME);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_ANIMATE_PREFIX",
                                 get_WIDGET_PROP_ANIMATE_PREFIX);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_ANIMATE_ANIMATING_TIME",
                                 get_WIDGET_PROP_ANIMATE_ANIMATING_TIME);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_DIRTY_RECT",
                                 get_WIDGET_PROP_DIRTY_RECT);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_SCREEN_SAVER_TIME",
                                 get_WIDGET_PROP_SCREEN_SAVER_TIME);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_SHOW_FPS",
                                 get_WIDGET_PROP_SHOW_FPS);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_MAX_FPS",
                                 get_WIDGET_PROP_MAX_FPS);
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_VALIDATOR",
                                 get_WIDGET_PROP_VALIDATOR);
...
ret_t widget_state_t_init(JSContext* ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_STATE_EMPTY_OVER",
                                 get_WIDGET_STATE_EMPTY_OVER);
...
ret_t widget_t_init(JSContext* ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"widget_find_parent_by_name",
                                 wrap_widget_find_parent_by_name);
  jerryx_handler_register_global((const jerry_char_t*)"widget_find_parent_by_type",
                                 wrap_widget_find_parent_by_type);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"widget_move_to_center",
                                 wrap_widget_move_to_center);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"widget_move_resize_ex",
                                 wrap_widget_move_resize_ex);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"widget_is_support_highlighter",
                                 wrap_widget_is_support_highlighter);
  jerryx_handler_register_global((const jerry_char_t*)"widget_has_highlighter",
                                 wrap_widget_has_highlighter);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"widget_set_text_utf8_ex",
                                 wrap_widget_set_text_utf8_ex);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"widget_get_theme_name",
                                 wrap_widget_get_theme_name);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"widget_is_fullscreen_window",
                                 wrap_widget_is_fullscreen_window);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"widget_add_child_default",
                                 wrap_widget_add_child_default);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"widget_t_get_prop_opacity",
                                 wrap_widget_t_get_prop_opacity);
...
ret_t asset_info_t_init(JSContext* ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"asset_info_is_in_rom",
                                 wrap_asset_info_is_in_rom);
  jerryx_handler_register_global((const jerry_char_t*)"asset_info_set_is_in_rom",
                                 wrap_asset_info_set_is_in_rom);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"asset_info_t_get_prop_flags",
                                 wrap_asset_info_t_get_prop_flags);
...
ret_t value_type_t_init(JSContext* ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"VALUE_TYPE_FUNC_DEF",
                                 get_VALUE_TYPE_FUNC_DEF);
  jerryx_handler_register_global((const jerry_char_t*)"VALUE_TYPE_POINTER_REF",
                                 get_VALUE_TYPE_POINTER_REF);
...
static HANDLER_PROTO(wrap_assets_manager_unref) {
  ...
  if (argc >= 2) {
    ...
    assets_manager_t* am =
        (assets_manager_t*)jsvalue_get_pointer(ctx, argv[0], "assets_manager_t*");
    const asset_info_t* info =
        (const asset_info_t*)jsvalue_get_pointer(ctx, argv[1], "const asset_info_t*");
...
static HANDLER_PROTO(wrap_widget_animator_event_t_get_prop_widget) {
  ...
  widget_animator_event_t* obj =
      (widget_animator_event_t*)jsvalue_get_pointer(ctx, argv[0], "widget_animator_event_t*");
...
ret_t widget_animator_event_t_init(JSContext* ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"widget_animator_event_cast",
                                 wrap_widget_animator_event_cast);
  jerryx_handler_register_global((const jerry_char_t*)"widget_animator_event_t_get_prop_widget",
                                 wrap_widget_animator_event_t_get_prop_widget);
  jerryx_handler_register_global((const jerry_char_t*)"widget_animator_event_t_get_prop_animator",
                                 wrap_widget_animator_event_t_get_prop_animator);
...
ret_t model_event_t_init(JSContext* ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"model_event_t_get_prop_name",
                                 wrap_model_event_t_get_prop_name);
  jerryx_handler_register_global((const jerry_char_t*)"model_event_t_get_prop_change_type",
                                 wrap_model_event_t_get_prop_change_type);
  jerryx_handler_register_global((const jerry_char_t*)"model_event_t_get_prop_model",
                                 wrap_model_event_t_get_prop_model);
...
ret_t key_event_t_init(JSContext* ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"key_event_t_get_prop_numlock",
                                 wrap_key_event_t_get_prop_numlock);
...
static HANDLER_PROTO(wrap_drop_file_event_t_get_prop_filename) {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  drop_file_event_t* obj =
      (drop_file_event_t*)jsvalue_get_pointer(ctx, argv[0], "drop_file_event_t*");
...
ret_t drop_file_event_t_init(JSContext* ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"drop_file_event_cast",
                                 wrap_drop_file_event_cast);
  jerryx_handler_register_global((const jerry_char_t*)"drop_file_event_t_get_prop_filename",
                                 wrap_drop_file_event_t_get_prop_filename);
...
ret_t window_base_t_init(JSContext* ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"window_base_t_get_prop_applet_name",
                                 wrap_window_base_t_get_prop_applet_name);
...
ret_t window_manager_t_init(JSContext* ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"window_manager_set_fullscreen",
                                 wrap_window_manager_set_fullscreen);
...
ret_t draggable_t_init(JSContext* ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"draggable_set_allow_out_of_screen",
                                 wrap_draggable_set_allow_out_of_screen);
  jerryx_handler_register_global((const jerry_char_t*)"draggable_set_drag_window",
                                 wrap_draggable_set_drag_window);
  jerryx_handler_register_global((const jerry_char_t*)"draggable_set_drag_native_window",
                                 wrap_draggable_set_drag_native_window);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"draggable_t_get_prop_allow_out_of_screen",
                                 wrap_draggable_t_get_prop_allow_out_of_screen);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"draggable_t_get_prop_drag_native_window",
                                 wrap_draggable_t_get_prop_drag_native_window);
...
ret_t file_browser_view_t_init(JSContext* ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"file_browser_view_set_odd_item_style",
                                 wrap_file_browser_view_set_odd_item_style);
  jerryx_handler_register_global((const jerry_char_t*)"file_browser_view_set_even_item_style",
                                 wrap_file_browser_view_set_even_item_style);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"file_browser_view_t_get_prop_odd_item_style",
                                 wrap_file_browser_view_t_get_prop_odd_item_style);
  jerryx_handler_register_global(
      (const jerry_char_t*)"file_browser_view_t_get_prop_even_item_style",
      wrap_file_browser_view_t_get_prop_even_item_style);
...
ret_t candidates_t_init(JSContext* ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"candidates_t_get_prop_enable_preview",
                                 wrap_candidates_t_get_prop_enable_preview);
...
ret_t line_number_t_init(JSContext* ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"line_number_add_highlight_line",
                                 wrap_line_number_add_highlight_line);
  jerryx_handler_register_global((const jerry_char_t*)"line_number_set_active_line",
                                 wrap_line_number_set_active_line);
  jerryx_handler_register_global((const jerry_char_t*)"line_number_clear_highlight",
                                 wrap_line_number_clear_highlight);
  jerryx_handler_register_global((const jerry_char_t*)"line_number_is_highlight_line",
                                 wrap_line_number_is_highlight_line);
...
ret_t scroll_bar_t_init(JSContext* ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"scroll_bar_hide_by_opacity_animation",
...
ret_t scroll_view_t_init(JSContext* ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"scroll_view_set_slide_limit_ratio",
                                 wrap_scroll_view_set_slide_limit_ratio);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"scroll_view_t_get_prop_slide_limit_ratio",
                                 wrap_scroll_view_t_get_prop_slide_limit_ratio);
...
ret_t serial_widget_t_init(JSContext* ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"serial_widget_create",
                                 wrap_serial_widget_create);
  jerryx_handler_register_global((const jerry_char_t*)"serial_widget_cast",
                                 wrap_serial_widget_cast);
  jerryx_handler_register_global((const jerry_char_t*)"serial_widget_set_baudrate",
                                 wrap_serial_widget_set_baudrate);
  jerryx_handler_register_global((const jerry_char_t*)"serial_widget_set_device",
                                 wrap_serial_widget_set_device);
  jerryx_handler_register_global((const jerry_char_t*)"serial_widget_set_bytesize",
                                 wrap_serial_widget_set_bytesize);
  jerryx_handler_register_global((const jerry_char_t*)"serial_widget_set_parity",
                                 wrap_serial_widget_set_parity);
  jerryx_handler_register_global((const jerry_char_t*)"serial_widget_set_stopbits",
                                 wrap_serial_widget_set_stopbits);
  jerryx_handler_register_global((const jerry_char_t*)"serial_widget_set_flowcontrol",
                                 wrap_serial_widget_set_flowcontrol);
  jerryx_handler_register_global((const jerry_char_t*)"serial_widget_set_check_interval",
                                 wrap_serial_widget_set_check_interval);
  jerryx_handler_register_global((const jerry_char_t*)"serial_widget_t_get_prop_device",
                                 wrap_serial_widget_t_get_prop_device);
  jerryx_handler_register_global((const jerry_char_t*)"serial_widget_t_get_prop_baudrate",
                                 wrap_serial_widget_t_get_prop_baudrate);
  jerryx_handler_register_global((const jerry_char_t*)"serial_widget_t_get_prop_bytesize",
                                 wrap_serial_widget_t_get_prop_bytesize);
  jerryx_handler_register_global((const jerry_char_t*)"serial_widget_t_get_prop_parity",
                                 wrap_serial_widget_t_get_prop_parity);
  jerryx_handler_register_global((const jerry_char_t*)"serial_widget_t_get_prop_stopbits",
...
ret_t slide_menu_t_init(JSContext* ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"slide_menu_set_spacer",
                                 wrap_slide_menu_set_spacer);
  jerryx_handler_register_global((const jerry_char_t*)"slide_menu_set_menu_w",
                                 wrap_slide_menu_set_menu_w);
  jerryx_handler_register_global((const jerry_char_t*)"slide_menu_set_clip",
                                 wrap_slide_menu_set_clip);
  jerryx_handler_register_global((const jerry_char_t*)"slide_menu_scroll_to_prev",
                                 wrap_slide_menu_scroll_to_prev);
  jerryx_handler_register_global((const jerry_char_t*)"slide_menu_scroll_to_next",
                                 wrap_slide_menu_scroll_to_next);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"slide_menu_t_get_prop_spacer",
                                 wrap_slide_menu_t_get_prop_spacer);
  jerryx_handler_register_global((const jerry_char_t*)"slide_menu_t_get_prop_menu_w",
                                 wrap_slide_menu_t_get_prop_menu_w);
  jerryx_handler_register_global((const jerry_char_t*)"slide_menu_t_get_prop_clip",
                                 wrap_slide_menu_t_get_prop_clip);
...
ret_t slide_view_t_init(JSContext* ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"slide_view_set_drag_threshold",
                                 wrap_slide_view_set_drag_threshold);
  jerryx_handler_register_global((const jerry_char_t*)"slide_view_set_animating_time",
                                 wrap_slide_view_set_animating_time);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"slide_view_t_get_prop_drag_threshold",
                                 wrap_slide_view_t_get_prop_drag_threshold);
  jerryx_handler_register_global((const jerry_char_t*)"slide_view_t_get_prop_animating_time",
                                 wrap_slide_view_t_get_prop_animating_time);
...
ret_t text_selector_t_init(JSContext* ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"text_selector_set_mask_easing",
                                 wrap_text_selector_set_mask_easing);
  jerryx_handler_register_global((const jerry_char_t*)"text_selector_set_mask_area_scale",
                                 wrap_text_selector_set_mask_area_scale);
  jerryx_handler_register_global((const jerry_char_t*)"text_selector_set_ellipses",
                                 wrap_text_selector_set_ellipses);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"text_selector_t_get_prop_ellipses",
                                 wrap_text_selector_t_get_prop_ellipses);
  jerryx_handler_register_global((const jerry_char_t*)"text_selector_t_get_prop_mask_easing",
                                 wrap_text_selector_t_get_prop_mask_easing);
  jerryx_handler_register_global((const jerry_char_t*)"text_selector_t_get_prop_mask_area_scale",
                                 wrap_text_selector_t_get_prop_mask_area_scale);
...
ret_t timer_widget_t_init(JSContext* ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"timer_widget_create",
                                 wrap_timer_widget_create);
  jerryx_handler_register_global((const jerry_char_t*)"timer_widget_cast", wrap_timer_widget_cast);
  jerryx_handler_register_global((const jerry_char_t*)"timer_widget_set_duration",
                                 wrap_timer_widget_set_duration);
  jerryx_handler_register_global((const jerry_char_t*)"timer_widget_t_get_prop_duration",
                                 wrap_timer_widget_t_get_prop_duration);
...
ret_t log_message_event_t_init(JSContext* ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"log_message_event_cast",
                                 wrap_log_message_event_cast);
...
ret_t button_t_init(JSContext* ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"button_set_enable_preview",
                                 wrap_button_set_enable_preview);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"button_t_get_prop_enable_preview",
                                 wrap_button_t_get_prop_enable_preview);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"button_t_get_prop_pressed",
                                 wrap_button_t_get_prop_pressed);
...
ret_t check_button_t_init(JSContext* ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"check_button_create_ex",
                                 wrap_check_button_create_ex);
...
ret_t edit_t_init(JSContext* ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"edit_set_double_ex",
                                 wrap_edit_set_double_ex);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"edit_t_get_prop_validator",
                                 wrap_edit_t_get_prop_validator);
...
ret_t grid_t_init(JSContext* ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"grid_set_columns_definition",
                                 wrap_grid_set_columns_definition);
  jerryx_handler_register_global((const jerry_char_t*)"grid_set_show_grid",
                                 wrap_grid_set_show_grid);
  jerryx_handler_register_global((const jerry_char_t*)"grid_t_get_prop_rows",
                                 wrap_grid_t_get_prop_rows);
  jerryx_handler_register_global((const jerry_char_t*)"grid_t_get_prop_columns_definition",
                                 wrap_grid_t_get_prop_columns_definition);
  jerryx_handler_register_global((const jerry_char_t*)"grid_t_get_prop_show_grid",
                                 wrap_grid_t_get_prop_show_grid);
...
ret_t group_box_t_init(JSContext* ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"group_box_set_value",
                                 wrap_group_box_set_value);
  jerryx_handler_register_global((const jerry_char_t*)"group_box_cast", wrap_group_box_cast);
  jerryx_handler_register_global((const jerry_char_t*)"group_box_t_get_prop_value",
                                 wrap_group_box_t_get_prop_value);
...
ret_t label_t_init(JSContext* ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"label_set_ellipses",
                                 wrap_label_set_ellipses);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"label_t_get_prop_ellipses",
                                 wrap_label_t_get_prop_ellipses);
...
ret_t pages_t_init(JSContext* ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"pages_set_auto_focused",
                                 wrap_pages_set_auto_focused);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"pages_t_get_prop_auto_focused",
                                 wrap_pages_t_get_prop_auto_focused);
...
ret_t slider_t_init(JSContext* ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"slider_set_line_cap",
                                 wrap_slider_set_line_cap);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"slider_t_get_prop_line_cap",
                                 wrap_slider_t_get_prop_line_cap);
...
ret_t list_item_seperator_t_init(JSContext* ctx) {
  jerryx_handler_register_global((const jerry_char_t*)"list_item_seperator_create",
                                 wrap_list_item_seperator_create);
  jerryx_handler_register_global((const jerry_char_t*)"list_item_seperator_cast",
                                 wrap_list_item_seperator_cast);
...
ret_t svg_image_t_init(JSContext* ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"svg_image_set_cache_mode",
                                 wrap_svg_image_set_cache_mode);
  jerryx_handler_register_global((const jerry_char_t*)"svg_image_set_draw_type",
                                 wrap_svg_image_set_draw_type);
  jerryx_handler_register_global((const jerry_char_t*)"svg_image_cast", wrap_svg_image_cast);
  jerryx_handler_register_global((const jerry_char_t*)"svg_image_t_get_prop_is_cache_mode",
                                 wrap_svg_image_t_get_prop_is_cache_mode);
  jerryx_handler_register_global((const jerry_char_t*)"svg_image_t_get_prop_draw_type",
                                 wrap_svg_image_t_get_prop_draw_type);
...
ret_t object_array_t_init(JSContext* ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"object_array_remove_value",
                                 wrap_object_array_remove_value);
...
ret_t object_default_t_init(JSContext* ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"object_default_set_keep_prop_type",
                                 wrap_object_default_set_keep_prop_type);
...
ret_t combo_box_t_init(JSContext* ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"combo_box_set_theme_of_popup",
                                 wrap_combo_box_set_theme_of_popup);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"combo_box_set_selected_index_by_text",
                                 wrap_combo_box_set_selected_index_by_text);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"combo_box_remove_option_by_index",
                                 wrap_combo_box_remove_option_by_index);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"combo_box_has_option_text",
                                 wrap_combo_box_has_option_text);
  jerryx_handler_register_global((const jerry_char_t*)"combo_box_get_text",
                                 wrap_combo_box_get_text);
  jerryx_handler_register_global((const jerry_char_t*)"combo_box_get_text_of_selected",
                                 wrap_combo_box_get_text_of_selected);
  jerryx_handler_register_global((const jerry_char_t*)"combo_box_t_get_prop_open_window",
                                 wrap_combo_box_t_get_prop_open_window);
  jerryx_handler_register_global((const jerry_char_t*)"combo_box_t_get_prop_theme_of_popup",
                                 wrap_combo_box_t_get_prop_theme_of_popup);
...
ret_t overlay_t_init(JSContext* ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"overlay_set_modeless",
                                 wrap_overlay_set_modeless);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"overlay_t_get_prop_modeless",
                                 wrap_overlay_t_get_prop_modeless);
...
ret_t spin_box_t_init(JSContext* ctx) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"spin_box_set_easy_touch_mode",
                                 wrap_spin_box_set_easy_touch_mode);
  jerryx_handler_register_global((const jerry_char_t*)"spin_box_set_button_position",
                                 wrap_spin_box_set_button_position);
  jerryx_handler_register_global((const jerry_char_t*)"spin_set_repeat", wrap_spin_set_repeat);
  jerryx_handler_register_global((const jerry_char_t*)"spin_box_t_get_prop_easy_touch_mode",
                                 wrap_spin_box_t_get_prop_easy_touch_mode);
  jerryx_handler_register_global((const jerry_char_t*)"spin_box_t_get_prop_button_position",
                                 wrap_spin_box_t_get_prop_button_position);
