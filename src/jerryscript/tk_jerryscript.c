...
jsvalue_t wrap_widget_set_cursor(const jerry_value_t func_obj_val, const jerry_value_t this_p,
                                 const jerry_value_t argv[], const jerry_length_t argc) {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if (argc >= 2) {
...
jsvalue_t wrap_widget_find_animator(const jerry_value_t func_obj_val, const jerry_value_t this_p,
                                    const jerry_value_t argv[], const jerry_length_t argc) {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if (argc >= 2) {
...
jsvalue_t wrap_tk_ext_widgets_init(const jerry_value_t func_obj_val, const jerry_value_t this_p,
                                   const jerry_value_t argv[], const jerry_length_t argc) {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if (argc >= 0) {
...
jsvalue_t wrap_value_float(const jerry_value_t func_obj_val, const jerry_value_t this_p,
                           const jerry_value_t argv[], const jerry_length_t argc) {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if (argc >= 1) {
...
jsvalue_t wrap_value_set_float32(const jerry_value_t func_obj_val, const jerry_value_t this_p,
                                 const jerry_value_t argv[], const jerry_length_t argc) {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if (argc >= 2) {
...
jsvalue_t wrap_value_wstr(const jerry_value_t func_obj_val, const jerry_value_t this_p,
                          const jerry_value_t argv[], const jerry_length_t argc) {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if (argc >= 1) {
...
jsvalue_t wrap_value_int(const jerry_value_t func_obj_val, const jerry_value_t this_p,
                         const jerry_value_t argv[], const jerry_length_t argc) {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if (argc >= 1) {
...
jsvalue_t wrap_style_mutable_get_name(const jerry_value_t func_obj_val, const jerry_value_t this_p,
                                      const jerry_value_t argv[], const jerry_length_t argc) {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if (argc >= 1) {
...
jsvalue_t wrap_object_set_prop_pointer(const jerry_value_t func_obj_val, const jerry_value_t this_p,
                                       const jerry_value_t argv[], const jerry_length_t argc) {
  void* ctx = NULL;
  jsvalue_t jret = JS_NULL;
  if (argc >= 3) {
...
jsvalue_t wrap_timer_info_t_get_prop_user_changed_time(const jerry_value_t func_obj_val,
                                                       const jerry_value_t this_p,
                                                       const jerry_value_t argv[],
                                                       const jerry_length_t argc) {
  void* ctx = NULL;
