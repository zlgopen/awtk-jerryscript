...
jerry_value_t get_BITMAP_FLAG_PREMULTI_ALPHA(const jerry_value_t func_obj_val,
                                             const jerry_value_t this_p,
                                             const jerry_value_t args_p[],
                                             const jerry_length_t args_cnt) {
...
jerry_value_t get_EVT_POINTER_DOWN_BEFORE_CHILDREN(const jerry_value_t func_obj_val,
                                                   const jerry_value_t this_p,
                                                   const jerry_value_t args_p[],
                                                   const jerry_length_t args_cnt) {
...
jerry_value_t get_EVT_POINTER_MOVE_BEFORE_CHILDREN(const jerry_value_t func_obj_val,
                                                   const jerry_value_t this_p,
                                                   const jerry_value_t args_p[],
                                                   const jerry_length_t args_cnt) {
...
jerry_value_t get_EVT_POINTER_UP_BEFORE_CHILDREN(const jerry_value_t func_obj_val,
                                                 const jerry_value_t this_p,
                                                 const jerry_value_t args_p[],
                                                 const jerry_length_t args_cnt) {
...
jerry_value_t get_EVT_KEY_DOWN_BEFORE_CHILDREN(const jerry_value_t func_obj_val,
                                               const jerry_value_t this_p,
                                               const jerry_value_t args_p[],
                                               const jerry_length_t args_cnt) {
...
jerry_value_t get_EVT_KEY_UP_BEFORE_CHILDREN(const jerry_value_t func_obj_val,
                                             const jerry_value_t this_p,
                                             const jerry_value_t args_p[],
                                             const jerry_length_t args_cnt) {
...
jerry_value_t get_EVT_WINDOW_TO_BACKGROUND(const jerry_value_t func_obj_val,
                                           const jerry_value_t this_p, const jerry_value_t args_p[],
                                           const jerry_length_t args_cnt) {
  return jerry_create_number(EVT_WINDOW_TO_BACKGROUND);
}

jerry_value_t get_EVT_WINDOW_TO_FOREGROUND(const jerry_value_t func_obj_val,
                                           const jerry_value_t this_p, const jerry_value_t args_p[],
                                           const jerry_length_t args_cnt) {
...
jerry_value_t get_STYLE_ID_SPACER(const jerry_value_t func_obj_val, const jerry_value_t this_p,
                                  const jerry_value_t args_p[], const jerry_length_t args_cnt) {
...
jerry_value_t get_STYLE_ID_MARGIN_LEFT(const jerry_value_t func_obj_val, const jerry_value_t this_p,
                                       const jerry_value_t args_p[],
                                       const jerry_length_t args_cnt) {
  return jerry_create_str(STYLE_ID_MARGIN_LEFT);
}

jerry_value_t get_STYLE_ID_MARGIN_RIGHT(const jerry_value_t func_obj_val,
                                        const jerry_value_t this_p, const jerry_value_t args_p[],
                                        const jerry_length_t args_cnt) {
  return jerry_create_str(STYLE_ID_MARGIN_RIGHT);
}

jerry_value_t get_STYLE_ID_MARGIN_TOP(const jerry_value_t func_obj_val, const jerry_value_t this_p,
                                      const jerry_value_t args_p[], const jerry_length_t args_cnt) {
  return jerry_create_str(STYLE_ID_MARGIN_TOP);
}

jerry_value_t get_STYLE_ID_MARGIN_BOTTOM(const jerry_value_t func_obj_val,
                                         const jerry_value_t this_p, const jerry_value_t args_p[],
                                         const jerry_length_t args_cnt) {
...
jerry_value_t wrap_style_set(const jerry_value_t func_obj_val, const jerry_value_t this_p,
                             const jerry_value_t args_p[], const jerry_length_t args_cnt) {
  ret_t ret = 0;
  jerry_value_t jret = 0;
  style_t* s = (style_t*)jerry_get_pointer(args_p[0], "style_t*");
...
jerry_value_t wrap_style_is_mutable(const jerry_value_t func_obj_val, const jerry_value_t this_p,
                                    const jerry_value_t args_p[], const jerry_length_t args_cnt) {
  bool_t ret = 0;
  jerry_value_t jret = 0;
  style_t* s = (style_t*)jerry_get_pointer(args_p[0], "style_t*");
...
jerry_value_t get_WIDGET_PROP_MOVE_FOCUS_NEXT_KEY(const jerry_value_t func_obj_val,
                                                  const jerry_value_t this_p,
                                                  const jerry_value_t args_p[],
                                                  const jerry_length_t args_cnt) {
...
jerry_value_t get_WIDGET_PROP_MOVE_FOCUS_PREV_KEY(const jerry_value_t func_obj_val,
                                                  const jerry_value_t this_p,
                                                  const jerry_value_t args_p[],
                                                  const jerry_length_t args_cnt) {
...
jerry_value_t get_WIDGET_TYPE_OVERLAY(const jerry_value_t func_obj_val, const jerry_value_t this_p,
                                      const jerry_value_t args_p[], const jerry_length_t args_cnt) {
...
jerry_value_t get_WIDGET_STATE_FOCUSED_OF_CHECKED(const jerry_value_t func_obj_val,
                                                  const jerry_value_t this_p,
                                                  const jerry_value_t args_p[],
                                                  const jerry_length_t args_cnt) {
...
jerry_value_t get_WIDGET_STATE_FOCUSED_OF_ACTIVE(const jerry_value_t func_obj_val,
                                                 const jerry_value_t this_p,
                                                 const jerry_value_t args_p[],
                                                 const jerry_length_t args_cnt) {
...
jerry_value_t wrap_widget_find_animator(const jerry_value_t func_obj_val,
                                        const jerry_value_t this_p, const jerry_value_t args_p[],
                                        const jerry_length_t args_cnt) {
...
jerry_value_t wrap_widget_set_style_int(const jerry_value_t func_obj_val,
                                        const jerry_value_t this_p, const jerry_value_t args_p[],
                                        const jerry_length_t args_cnt) {
  ret_t ret = 0;
  jerry_value_t jret = 0;
...
jerry_value_t wrap_widget_set_style_str(const jerry_value_t func_obj_val,
                                        const jerry_value_t this_p, const jerry_value_t args_p[],
                                        const jerry_length_t args_cnt) {
  ret_t ret = 0;
  jerry_value_t jret = 0;
...
jerry_value_t wrap_widget_set_style_color(const jerry_value_t func_obj_val,
                                          const jerry_value_t this_p, const jerry_value_t args_p[],
                                          const jerry_length_t args_cnt) {
  ret_t ret = 0;
  jerry_value_t jret = 0;
...
ret_t widget_t_init(void) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"widget_find_animator",
                                 wrap_widget_find_animator);
...
jerry_value_t get_RET_SKIP(const jerry_value_t func_obj_val, const jerry_value_t this_p,
                           const jerry_value_t args_p[], const jerry_length_t args_cnt) {
...
jerry_value_t wrap_pointer_event_t_get_prop_cmd(const jerry_value_t func_obj_val,
                                                const jerry_value_t this_p,
                                                const jerry_value_t args_p[],
                                                const jerry_length_t args_cnt) {
  pointer_event_t* obj = (pointer_event_t*)jerry_get_pointer(args_p[0], "pointer_event_t*");
...
jerry_value_t wrap_pointer_event_t_get_prop_menu(const jerry_value_t func_obj_val,
                                                 const jerry_value_t this_p,
                                                 const jerry_value_t args_p[],
                                                 const jerry_length_t args_cnt) {
  pointer_event_t* obj = (pointer_event_t*)jerry_get_pointer(args_p[0], "pointer_event_t*");
...
jerry_value_t wrap_key_event_t_get_prop_lalt(const jerry_value_t func_obj_val,
                                             const jerry_value_t this_p,
                                             const jerry_value_t args_p[],
                                             const jerry_length_t args_cnt) {
  key_event_t* obj = (key_event_t*)jerry_get_pointer(args_p[0], "key_event_t*");
...
jerry_value_t wrap_key_event_t_get_prop_ralt(const jerry_value_t func_obj_val,
                                             const jerry_value_t this_p,
                                             const jerry_value_t args_p[],
                                             const jerry_length_t args_cnt) {
  key_event_t* obj = (key_event_t*)jerry_get_pointer(args_p[0], "key_event_t*");
...
jerry_value_t wrap_key_event_t_get_prop_lctrl(const jerry_value_t func_obj_val,
                                              const jerry_value_t this_p,
                                              const jerry_value_t args_p[],
                                              const jerry_length_t args_cnt) {
  key_event_t* obj = (key_event_t*)jerry_get_pointer(args_p[0], "key_event_t*");
...
jerry_value_t wrap_key_event_t_get_prop_rctrl(const jerry_value_t func_obj_val,
                                              const jerry_value_t this_p,
                                              const jerry_value_t args_p[],
                                              const jerry_length_t args_cnt) {
  key_event_t* obj = (key_event_t*)jerry_get_pointer(args_p[0], "key_event_t*");
...
jerry_value_t wrap_key_event_t_get_prop_lshift(const jerry_value_t func_obj_val,
                                               const jerry_value_t this_p,
                                               const jerry_value_t args_p[],
                                               const jerry_length_t args_cnt) {
  key_event_t* obj = (key_event_t*)jerry_get_pointer(args_p[0], "key_event_t*");
...
jerry_value_t wrap_key_event_t_get_prop_rshift(const jerry_value_t func_obj_val,
                                               const jerry_value_t this_p,
                                               const jerry_value_t args_p[],
                                               const jerry_length_t args_cnt) {
  key_event_t* obj = (key_event_t*)jerry_get_pointer(args_p[0], "key_event_t*");
...
jerry_value_t wrap_key_event_t_get_prop_cmd(const jerry_value_t func_obj_val,
                                            const jerry_value_t this_p,
                                            const jerry_value_t args_p[],
                                            const jerry_length_t args_cnt) {
  key_event_t* obj = (key_event_t*)jerry_get_pointer(args_p[0], "key_event_t*");
...
jerry_value_t wrap_key_event_t_get_prop_menu(const jerry_value_t func_obj_val,
                                             const jerry_value_t this_p,
                                             const jerry_value_t args_p[],
                                             const jerry_length_t args_cnt) {
  key_event_t* obj = (key_event_t*)jerry_get_pointer(args_p[0], "key_event_t*");
...
jerry_value_t wrap_guage_pointer_set_anchor(const jerry_value_t func_obj_val,
                                            const jerry_value_t this_p,
                                            const jerry_value_t args_p[],
                                            const jerry_length_t args_cnt) {
  ret_t ret = 0;
...
jerry_value_t wrap_guage_pointer_t_get_prop_anchor_x(const jerry_value_t func_obj_val,
                                                     const jerry_value_t this_p,
                                                     const jerry_value_t args_p[],
                                                     const jerry_length_t args_cnt) {
  guage_pointer_t* obj = (guage_pointer_t*)jerry_get_pointer(args_p[0], "guage_pointer_t*");
...
jerry_value_t wrap_guage_pointer_t_get_prop_anchor_y(const jerry_value_t func_obj_val,
                                                     const jerry_value_t this_p,
                                                     const jerry_value_t args_p[],
                                                     const jerry_length_t args_cnt) {
  guage_pointer_t* obj = (guage_pointer_t*)jerry_get_pointer(args_p[0], "guage_pointer_t*");
...
jerry_value_t wrap_overlay_create(const jerry_value_t func_obj_val, const jerry_value_t this_p,
                                  const jerry_value_t args_p[], const jerry_length_t args_cnt) {
  widget_t* ret = NULL;
  jerry_value_t jret = 0;
  widget_t* parent = (widget_t*)jerry_get_pointer(args_p[0], "widget_t*");
...
jerry_value_t wrap_overlay_cast(const jerry_value_t func_obj_val, const jerry_value_t this_p,
                                const jerry_value_t args_p[], const jerry_length_t args_cnt) {
  widget_t* ret = NULL;
  jerry_value_t jret = 0;
  widget_t* widget = (widget_t*)jerry_get_pointer(args_p[0], "widget_t*");
