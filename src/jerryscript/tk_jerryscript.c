...
jerry_value_t wrap_color_create_with_str(const jerry_value_t func_obj_val,
                                         const jerry_value_t this_p, const jerry_value_t args_p[],
                                         const jerry_length_t args_cnt) {
  color_t* ret = NULL;
...
jerry_value_t wrap_color_destroy(const jerry_value_t func_obj_val, const jerry_value_t this_p,
                                 const jerry_value_t args_p[], const jerry_length_t args_cnt) {
  ret_t ret = 0;
  color_t* c = (color_t*)jerry_get_pointer(args_p[0], "color_t*");
...
ret_t color_t_init(void) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"color_create_with_str",
                                 wrap_color_create_with_str);
...
jerry_value_t wrap_date_time_destroy(const jerry_value_t func_obj_val, const jerry_value_t this_p,
                                     const jerry_value_t args_p[], const jerry_length_t args_cnt) {
  ret_t ret = 0;
...
jerry_value_t wrap_emitter_create(const jerry_value_t func_obj_val, const jerry_value_t this_p,
  ...
  return jerry_create_pointer(ret, "emitter_t*");
}
...
jerry_value_t wrap_emitter_destroy(const jerry_value_t func_obj_val, const jerry_value_t this_p,
                                   const jerry_value_t args_p[], const jerry_length_t args_cnt) {
  ret_t ret = 0;
  emitter_t* emitter = (emitter_t*)jerry_get_pointer(args_p[0], "emitter_t*");
...
ret_t emitter_t_init(void) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"emitter_destroy", wrap_emitter_destroy);
...
jerry_value_t wrap_event_destroy(const jerry_value_t func_obj_val, const jerry_value_t this_p,
                                 const jerry_value_t args_p[], const jerry_length_t args_cnt) {
  ret_t ret = 0;
  event_t* event = (event_t*)jerry_get_pointer(args_p[0], "event_t*");
...
ret_t event_t_init(void) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"event_destroy", wrap_event_destroy);
...
jerry_value_t wrap_named_value_destroy(const jerry_value_t func_obj_val, const jerry_value_t this_p,
                                       const jerry_value_t args_p[],
                                       const jerry_length_t args_cnt) {
  ret_t ret = 0;
  named_value_t* nv = (named_value_t*)jerry_get_pointer(args_p[0], "named_value_t*");
...
ret_t named_value_t_init(void) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"named_value_destroy",
                                 wrap_named_value_destroy);
...
jerry_value_t wrap_rect_destroy(const jerry_value_t func_obj_val, const jerry_value_t this_p,
                                const jerry_value_t args_p[], const jerry_length_t args_cnt) {
  ret_t ret = 0;
...
jerry_value_t wrap_object_unref(const jerry_value_t func_obj_val, const jerry_value_t this_p,
                                const jerry_value_t args_p[], const jerry_length_t args_cnt) {
  ret_t ret = 0;
...
ret_t object_t_init(void) {
  jerryx_handler_register_global((const jerry_char_t*)"object_unref", wrap_object_unref);
...
jerry_value_t wrap_timer_info_cast(const jerry_value_t func_obj_val, const jerry_value_t this_p,
  ...
  return jerry_create_pointer(ret, "timer_info_t*");
}
...
jerry_value_t wrap_timer_info_t_get_prop_ctx(const jerry_value_t func_obj_val,
  ...
  return jerry_create_pointer(obj->ctx, "void*");
}
...
jerry_value_t wrap_idle_info_cast(const jerry_value_t func_obj_val, const jerry_value_t this_p,
  ...
  return jerry_create_pointer(ret, "idle_info_t*");
}
