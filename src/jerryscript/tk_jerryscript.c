...
jerry_value_t get_BITMAP_FMT_RGBA(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
...
jerry_value_t get_BITMAP_FMT_BGRA(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
...
jerry_value_t get_IMAGE_DRAW_9PATCH(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
  ) {
  return jerry_create_number(IMAGE_DRAW_9PATCH);
}

jerry_value_t get_IMAGE_DRAW_3PATCH_X(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
  ) {
  return jerry_create_number(IMAGE_DRAW_3PATCH_X);
}

jerry_value_t get_IMAGE_DRAW_3PATCH_Y(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
  ) {
  return jerry_create_number(IMAGE_DRAW_3PATCH_Y);
}

jerry_value_t get_IMAGE_DRAW_3PATCH_X_SCALE_Y(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
  ) {
  return jerry_create_number(IMAGE_DRAW_3PATCH_X_SCALE_Y);
}

jerry_value_t get_IMAGE_DRAW_3PATCH_Y_SCALE_X(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
  ) {
  return jerry_create_number(IMAGE_DRAW_3PATCH_Y_SCALE_X);
}
...
ret_t image_draw_type_t_init(void) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"IMAGE_DRAW_9PATCH", get_IMAGE_DRAW_9PATCH);
  jerryx_handler_register_global((const jerry_char_t*)"IMAGE_DRAW_3PATCH_X", get_IMAGE_DRAW_3PATCH_X);
  jerryx_handler_register_global((const jerry_char_t*)"IMAGE_DRAW_3PATCH_Y", get_IMAGE_DRAW_3PATCH_Y);
  jerryx_handler_register_global((const jerry_char_t*)"IMAGE_DRAW_3PATCH_X_SCALE_Y", get_IMAGE_DRAW_3PATCH_X_SCALE_Y);
  jerryx_handler_register_global((const jerry_char_t*)"IMAGE_DRAW_3PATCH_Y_SCALE_X", get_IMAGE_DRAW_3PATCH_Y_SCALE_X);
...
jerry_value_t wrap_combo_box_item_set_selected(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
...
jerry_value_t wrap_combo_box_item_t_get_prop_selected(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
...
ret_t combo_box_item_t_init(void) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"combo_box_item_set_selected", wrap_combo_box_item_set_selected);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"combo_box_item_t_get_prop_selected", wrap_combo_box_item_t_get_prop_selected);
...
jerry_value_t wrap_key_event_t_get_prop_caplock(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
...
ret_t key_event_t_init(void) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"key_event_t_get_prop_caplock", wrap_key_event_t_get_prop_caplock);
...
jerry_value_t wrap_image_manager_load(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
...
ret_t image_manager_t_init(void) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"image_manager_load", wrap_image_manager_load);
...
jerry_value_t wrap_image_set_image_name(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
...
jerry_value_t wrap_image_t_get_prop_anchor_x(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
...
jerry_value_t wrap_image_t_get_prop_anchor_y(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
...
jerry_value_t wrap_image_t_get_prop_scale_x(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
...
ret_t image_t_init(void) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"image_set_image_name", wrap_image_set_image_name);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"image_t_get_prop_anchor_x", wrap_image_t_get_prop_anchor_x);
  jerryx_handler_register_global((const jerry_char_t*)"image_t_get_prop_anchor_y", wrap_image_t_get_prop_anchor_y);
  jerryx_handler_register_global((const jerry_char_t*)"image_t_get_prop_scale_x", wrap_image_t_get_prop_scale_x);
...
jerry_value_t wrap_popup_t_get_prop_theme(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
...
jerry_value_t wrap_popup_t_get_prop_anim_hint(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
...
ret_t popup_t_init(void) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"popup_t_get_prop_theme", wrap_popup_t_get_prop_theme);
  jerryx_handler_register_global((const jerry_char_t*)"popup_t_get_prop_anim_hint", wrap_popup_t_get_prop_anim_hint);
...
jerry_value_t get_RESOURCE_TYPE_NONE(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
...
jerry_value_t get_RESOURCE_TYPE_FONT(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
...
jerry_value_t get_RESOURCE_TYPE_IMAGE(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
...
jerry_value_t get_RESOURCE_TYPE_THEME(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
...
jerry_value_t get_RESOURCE_TYPE_UI(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
...
jerry_value_t get_RESOURCE_TYPE_XML(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
...
jerry_value_t get_RESOURCE_TYPE_STRINGS(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
...
jerry_value_t get_RESOURCE_TYPE_DATA(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
...
ret_t resource_type_t_init(void) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"RESOURCE_TYPE_IMAGE", get_RESOURCE_TYPE_IMAGE);
  jerryx_handler_register_global((const jerry_char_t*)"RESOURCE_TYPE_THEME", get_RESOURCE_TYPE_THEME);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"RESOURCE_TYPE_STRINGS", get_RESOURCE_TYPE_STRINGS);
  jerryx_handler_register_global((const jerry_char_t*)"RESOURCE_TYPE_DATA", get_RESOURCE_TYPE_DATA);

 return RET_OK;
}

jerry_value_t wrap_resource_info_t_get_prop_type(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
...
jerry_value_t wrap_resource_info_t_get_prop_size(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
...
jerry_value_t wrap_resource_info_t_get_prop_name(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
...
ret_t resource_info_t_init(void) {
  jerryx_handler_register_global((const jerry_char_t*)"resource_info_t_get_prop_type", wrap_resource_info_t_get_prop_type);
  jerryx_handler_register_global((const jerry_char_t*)"resource_info_t_get_prop_size", wrap_resource_info_t_get_prop_size);
  jerryx_handler_register_global((const jerry_char_t*)"resource_info_t_get_prop_name", wrap_resource_info_t_get_prop_name);

 return RET_OK;
}

jerry_value_t wrap_resource_manager(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
...
jerry_value_t wrap_resource_manager_ref(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
...
jerry_value_t wrap_resource_manager_unref(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
...
ret_t resource_manager_t_init(void) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"resource_manager_ref", wrap_resource_manager_ref);
  jerryx_handler_register_global((const jerry_char_t*)"resource_manager_unref", wrap_resource_manager_unref);
...
jerry_value_t wrap_tklocale_tr(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
...
jerry_value_t wrap_tklocale_change(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
...
jerry_value_t wrap_value_t_get_prop_type(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
...
ret_t value_t_init(void) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"value_t_get_prop_type", wrap_value_t_get_prop_type);
...
jerry_value_t get_WIDGET_PROP_SUB_THEME(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
...
ret_t widget_prop_t_init(void) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"WIDGET_PROP_SUB_THEME", get_WIDGET_PROP_SUB_THEME);
...
jerry_value_t wrap_widget_set_text(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
  ...
  ret_t ret = 0;
  widget_t* widget = (widget_t*)jerry_get_pointer(args_p[0], "widget_t*");
  wchar_t* text = (wchar_t*)jerry_get_wstring(args_p[1]);
...
jerry_value_t wrap_widget_on(
  ...
  event_func_t on_event = (event_func_t)jerry_get_pointer(args_p[2], "event_func_t");
  void* ctx =  NULL;
  ret = (int32_t)widget_on(widget, type, on_event, ctx);
...
jerry_value_t wrap_widget_set_children_layout_params(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
...
jerry_value_t wrap_widget_t_get_prop_style_name(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
...
ret_t widget_t_init(void) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"widget_set_text", wrap_widget_set_text);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"widget_set_children_layout_params", wrap_widget_set_children_layout_params);
  ...
  jerryx_handler_register_global((const jerry_char_t*)"widget_t_get_prop_style_name", wrap_widget_t_get_prop_style_name);
...
jerry_value_t wrap_window_t_get_prop_theme(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
...
jerry_value_t wrap_window_t_get_prop_anim_hint(
    const jerry_value_t func_obj_val, 
    const jerry_value_t this_p, 
    const jerry_value_t args_p[], 
    const jerry_length_t args_cnt
...
ret_t window_t_init(void) {
  ...
  jerryx_handler_register_global((const jerry_char_t*)"window_t_get_prop_theme", wrap_window_t_get_prop_theme);
  jerryx_handler_register_global((const jerry_char_t*)"window_t_get_prop_anim_hint", wrap_window_t_get_prop_anim_hint);
