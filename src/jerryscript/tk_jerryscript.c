...
jsvalue_t wrap_bitmap_get_bpp(
  ...
  if(argc >= 1) {
  uint32_t ret = 0;
  bitmap_t* bitmap = (bitmap_t*)jsvalue_get_object(ctx, argv[0], "bitmap_t*", &s_bitmap_destroy_info);
...
jsvalue_t wrap_bitmap_t_get_prop_w(
    ...
    void* ctx = NULL;
    jsvalue_t jret = JS_NULL;
  bitmap_t* obj = (bitmap_t*)jsvalue_get_object(ctx, argv[0], "bitmap_t*", &s_bitmap_destroy_info);
...
jsvalue_t wrap_canvas_get_clip_rect(
  ...
  ret_t ret = 0;
  canvas_t* c = (canvas_t*)jsvalue_get_pointer(ctx, argv[0], "canvas_t*");
  rect_t* r = (rect_t*)jsvalue_get_object(ctx, argv[1], "rect_t*", &s_rect_destroy_info);
...
jsvalue_t wrap_canvas_draw_icon(
  ...
  ret_t ret = 0;
  canvas_t* c = (canvas_t*)jsvalue_get_pointer(ctx, argv[0], "canvas_t*");
  bitmap_t* img = (bitmap_t*)jsvalue_get_object(ctx, argv[1], "bitmap_t*", &s_bitmap_destroy_info);
...
jsvalue_t wrap_canvas_draw_image(
  ...
  canvas_t* c = (canvas_t*)jsvalue_get_pointer(ctx, argv[0], "canvas_t*");
  bitmap_t* img = (bitmap_t*)jsvalue_get_object(ctx, argv[1], "bitmap_t*", &s_bitmap_destroy_info);
  rect_t* src = (rect_t*)jsvalue_get_object(ctx, argv[2], "rect_t*", &s_rect_destroy_info);
  rect_t* dst = (rect_t*)jsvalue_get_object(ctx, argv[3], "rect_t*", &s_rect_destroy_info);
...
jsvalue_t wrap_image_manager_get_bitmap(
  ...
  char* name = (char*)jsvalue_get_utf8_string(ctx, argv[1]);
  bitmap_t* image = (bitmap_t*)jsvalue_get_object(ctx, argv[2], "bitmap_t*", &s_bitmap_destroy_info);
...
jsvalue_t wrap_vgcanvas_paint(
  ...
  bitmap_t* img = (bitmap_t*)jsvalue_get_object(ctx, argv[2], "bitmap_t*", &s_bitmap_destroy_info);
...
jsvalue_t wrap_color_from_str(
  ...
  if(argc >= 2) {
  color_t* ret = NULL;
  color_t* c = (color_t*)jsvalue_get_object(ctx, argv[0], "color_t*", &s_color_destroy_info);
  const char* str = (const char*)jsvalue_get_utf8_string(ctx, argv[1]);
...
jsvalue_t wrap_color_cast(
  ...
  if(argc >= 1) {
  color_t* ret = NULL;
  color_t* color = (color_t*)jsvalue_get_object(ctx, argv[0], "color_t*", &s_color_destroy_info);
...
jsvalue_t wrap_color_t_set_prop_color(
    ...
    void* ctx = NULL;
    color_t* obj = (color_t*)jsvalue_get_object(ctx, argv[0], "color_t*", &s_color_destroy_info);
...
jsvalue_t wrap_date_time_t_get_prop_second(
    ...
    void* ctx = NULL;
    jsvalue_t jret = JS_NULL;
  date_time_t* obj = (date_time_t*)jsvalue_get_object(ctx, argv[0], "date_time_t*", &s_date_time_destroy_info);
...
jsvalue_t wrap_emitter_dispatch(
  ...
  if(argc >= 2) {
  ret_t ret = 0;
  emitter_t* emitter = (emitter_t*)jsvalue_get_object(ctx, argv[0], "emitter_t*", &s_emitter_destroy_info);
  event_t* e = (event_t*)jsvalue_get_object(ctx, argv[1], "event_t*", &s_event_destroy_info);
...
jsvalue_t wrap_event_cast(
  ...
  if(argc >= 1) {
  event_t* ret = NULL;
  event_t* event = (event_t*)jsvalue_get_object(ctx, argv[0], "event_t*", &s_event_destroy_info);
...
jsvalue_t wrap_event_t_get_prop_type(
    ...
    void* ctx = NULL;
    jsvalue_t jret = JS_NULL;
  event_t* obj = (event_t*)jsvalue_get_object(ctx, argv[0], "event_t*", &s_event_destroy_info);
...
jsvalue_t wrap_named_value_cast(
  ...
  if(argc >= 1) {
  named_value_t* ret = NULL;
  named_value_t* nv = (named_value_t*)jsvalue_get_object(ctx, argv[0], "named_value_t*", &s_named_value_destroy_info);
...
jsvalue_t wrap_named_value_t_get_prop_name(
    ...
    void* ctx = NULL;
    jsvalue_t jret = JS_NULL;
  named_value_t* obj = (named_value_t*)jsvalue_get_object(ctx, argv[0], "named_value_t*", &s_named_value_destroy_info);
...
jsvalue_t wrap_rect_set(
  ...
  if(argc >= 5) {
  rect_t* ret = NULL;
  rect_t* rect = (rect_t*)jsvalue_get_object(ctx, argv[0], "rect_t*", &s_rect_destroy_info);
  xy_t x = (xy_t)jsvalue_get_int_value(ctx, argv[1]);
  xy_t y = (xy_t)jsvalue_get_int_value(ctx, argv[2]);
  wh_t w = (wh_t)jsvalue_get_int_value(ctx, argv[3]);
  wh_t h = (wh_t)jsvalue_get_int_value(ctx, argv[4]);
...
jsvalue_t wrap_rect_t_get_prop_x(
    ...
    void* ctx = NULL;
    jsvalue_t jret = JS_NULL;
  rect_t* obj = (rect_t*)jsvalue_get_object(ctx, argv[0], "rect_t*", &s_rect_destroy_info);
...
jsvalue_t wrap_value_set_bool(
  ...
  if(argc >= 2) {
  value_t* ret = NULL;
  value_t* v = (value_t*)jsvalue_get_object(ctx, argv[0], "value_t*", &s_value_destroy_info);
  bool_t value = (bool_t)jsvalue_get_boolean_value(ctx, argv[1]);
...
jsvalue_t wrap_value_is_null(
  ...
  if(argc >= 1) {
  bool_t ret = 0;
  value_t* value = (value_t*)jsvalue_get_object(ctx, argv[0], "value_t*", &s_value_destroy_info);
...
jsvalue_t wrap_value_set_object(
  ...
  value_t* ret = NULL;
  value_t* v = (value_t*)jsvalue_get_object(ctx, argv[0], "value_t*", &s_value_destroy_info);
  object_t* value = (object_t*)jsvalue_get_object(ctx, argv[1], "object_t*", &s_object_unref_info);
...
jsvalue_t wrap_object_ref(
  ...
  if(argc >= 1) {
  object_t* ret = NULL;
  object_t* obj = (object_t*)jsvalue_get_object(ctx, argv[0], "object_t*", &s_object_unref_info);
...
jsvalue_t wrap_object_compare(
  ...
  int ret = 0;
  object_t* obj = (object_t*)jsvalue_get_object(ctx, argv[0], "object_t*", &s_object_unref_info);
  object_t* other = (object_t*)jsvalue_get_object(ctx, argv[1], "object_t*", &s_object_unref_info);
...
jsvalue_t wrap_object_get_prop(
  ...
  object_t* obj = (object_t*)jsvalue_get_object(ctx, argv[0], "object_t*", &s_object_unref_info);
  const char* name = (const char*)jsvalue_get_utf8_string(ctx, argv[1]);
  value_t* v = (value_t*)jsvalue_get_object(ctx, argv[2], "value_t*", &s_value_destroy_info);
...
jsvalue_t wrap_object_set_prop(
  ...
  object_t* obj = (object_t*)jsvalue_get_object(ctx, argv[0], "object_t*", &s_object_unref_info);
  const char* name = (const char*)jsvalue_get_utf8_string(ctx, argv[1]);
  value_t* value = (value_t*)jsvalue_get_object(ctx, argv[2], "value_t*", &s_value_destroy_info);
...
jsvalue_t wrap_object_set_prop_object(
  ...
  object_t* obj = (object_t*)jsvalue_get_object(ctx, argv[0], "object_t*", &s_object_unref_info);
  const char* name = (const char*)jsvalue_get_utf8_string(ctx, argv[1]);
  object_t* value = (object_t*)jsvalue_get_object(ctx, argv[2], "object_t*", &s_object_unref_info);
...
jsvalue_t wrap_object_copy_prop(
  ...
  ret_t ret = 0;
  object_t* obj = (object_t*)jsvalue_get_object(ctx, argv[0], "object_t*", &s_object_unref_info);
  object_t* src = (object_t*)jsvalue_get_object(ctx, argv[1], "object_t*", &s_object_unref_info);
  const char* name = (const char*)jsvalue_get_utf8_string(ctx, argv[2]);
...
jsvalue_t wrap_object_default_t_get_prop_props_size(
    ...
    void* ctx = NULL;
    jsvalue_t jret = JS_NULL;
  object_default_t* obj = (object_default_t*)jsvalue_get_object(ctx, argv[0], "object_default_t*", &s_object_default_unref_info);
